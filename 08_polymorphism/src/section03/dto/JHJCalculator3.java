 ...
 * 
 * - 인터페이스의 메서드는
 *   default 메서드를 제외하면 모두 추상메서드(미완성 메서드)
 *   -> 상속받은 자식이 오버라이딩(재정의) 해야 사용가능
 *   
 *   
 * - 미완성된 메서드는 이름이 같아도 하나만 구현하면 오류 없이 사용가능!
 * 
 * - 단, default 메서드는 중복되면 안된다!
 * 
 *  */
public class JHJCalculator3 implements Calculator, Machine{
