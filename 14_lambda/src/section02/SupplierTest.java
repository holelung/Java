...
public class SupplierTest {
	public static void main(String[] args) {
		...
		System.out.println("네 번째 번호 : " + lottoNumber.getAsInt());
		System.out.println("다섯 번째 번호 : " + lottoNumber.getAsInt());
		System.out.println("여셧 번째 번호 : " + lottoNumber.getAsInt());
